//
//  AboutFootballApp.swift
//  FootballApp
//

import Foundation

struct AboutFootballApp: Hashable {
    let question: String
    let answer: String
}

extension AboutFootballApp {
    static var about: [AboutFootballApp] {
        [
            AboutFootballApp(
                question: "What is Football app?",
                answer: "Football app is a media app for everything related to football."
            ),
            
            AboutFootballApp(
                question: "Who developed Football app?",
                answer: "Football app was developed by a developer named Eduard"
            ),
            
            AboutFootballApp(
                question: "What is the license of Football app?",
                answer: "Football app is licensed under the MIT license"
            ),
            
            AboutFootballApp(
                question: "What features does FootballApp offer?",
                answer: """
- You can view leagues.
- You can view teams.
...
...
"""
            ...
            AboutFootballApp(
                question: "What tools did the developer use for Football app?",
                answer: """
- Swift
- SwiftUI
- StoreKit
